				...
				<section className="container">
					<div className={`${styles.weddings_info} pt_60 pb_100 text_center`}>
						...
						<div className={`${styles.para_section}`}>
							...
							<p className="text_18_m pb_20" data-scroll>
								At <a href="https://www.gd-partners.in" target="_blank" rel="noopener noreferrer" style={{ color: "inherit",fontWeight:"bold" }}>GD Partners</a>, we fuse dharmic wisdom with today&apos;s realities to
